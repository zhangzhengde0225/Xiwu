...
class BaseArgs:
    ...
    top_p: float = field(default=0.9, metadata={"help": "Top-p for text generation."})
    top_k: int = field(default=0, metadata={"help": "Top-k for text generation."})
    ...
    stop_str: str = field(default=None, metadata={"help": "Stop generation at this string."})
