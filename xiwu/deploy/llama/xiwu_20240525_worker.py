...
from xiwu.modules.models.llama import Llama3
...
class WorkerModel(BaseWorkerModel):
    def __init__(self, args, **kwargs):
        ...
        self.xmodel: XBaseModel = Llama3(args=args, **kwargs)
...
class ModelArgs(BaseArgs):
    name: str = "Xiwu-8B-Instruct"  # worker的名称，用于注册到控制器
    model_path: str = '/data1/sqr/Models/Llama-3-8B-Instruct-all-1epoch-1e-5-idf-1e-4'
    # 其他参数
...
class WorkerArgs:
    ...
    description: str = 'Xiwu from IHEP'  # 模型的描述
