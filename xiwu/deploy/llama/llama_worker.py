...
class ModelArgs(BaseArgs):
    name: str = "Meta-Llama-3-8B-Instruct"  # worker的名称，用于注册到控制器
    model_path: str = '/data1/sqr/Models/Meta-Llama-3-8B-Instruct'
    # 其他参数
...
class WorkerArgs:
    ...
    description: str = 'Llama-3 from meta-llama'  # 模型的描述
