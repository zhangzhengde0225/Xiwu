...
from xiwu.modules.models.qwen import Qwen
...
class WorkerModel(BaseWorkerModel):
    def __init__(self, args, **kwargs):
        ...
        self.xmodel: XBaseModel = Qwen(args=args, **kwargs)
...
class ModelArgs(BaseArgs):
    name: str = "Qwen1.5-7B-Chat"  # worker的名称，用于注册到控制器
    model_path: str = '/data1/sqr/Models/Qwen1.5-7B-Chat'
    # 其他参数
...
class WorkerArgs:
    ...
    description: str = 'Qwen1.5 from Qwen'  # 模型的描述
